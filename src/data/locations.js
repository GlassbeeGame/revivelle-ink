...
export const locations = [
...

  {
    ...
    hero: {
      title: 'Paramedical Tattoo Services in Incline Village, NV',
      subtitle: 'Professional stretch mark and scar camouflage serving Incline Village residents. Approximately 35 minutes from our Sparks studio.',
    },
    ...
    benefits: [
      ...
      'Scenic drive via Mount Rose Highway',
      'Private, appointment-only studio',
      'Free consultations available by phone or in-person',
      'Flexible scheduling for longer-drive clients',
      'Same professional services and pricing as our Sparks location',
      'Licensed, insured, and Washoe County compliant',
    ],
    ...
    process: [
      {
        step: '01',
        title: 'Easy to Find',
        description: 'From Incline Village, take NV-431 (Mount Rose Highway) toward Reno/Sparks. Continue down the pass, then connect to S. Virginia Street or I-580 North toward Sparks. Follow local directions to Green Vista Drive, where our studio is located in a quiet professional building.',
      },
      {
        step: '02',
        title: 'Plan Your Visit',
        description: 'Most Incline Village residents can expect a 35–40 minute drive, depending on weather and time of day. Winter conditions may require extra travel time. Many clients prefer mid-morning or early afternoon appointments for optimal road conditions. Parking is available near the studio.',
      },
      {
        step: '03',
        title: 'Your Appointment',
        description: 'Appointments are scheduled intentionally to provide a private, unrushed experience. Incline Village clients often plan longer appointment windows or combine consultation and treatment when appropriate.',
      },
      {
        step: '04',
        title: 'Follow-Up Care',
        description: 'If multiple sessions are recommended, follow-ups are scheduled thoughtfully around travel and healing timelines. Ongoing aftercare guidance is provided between visits from our Sparks studio.',
      },
    ],
    ...
    pricing: {
      ...
      details: [
        ...
        'Most clients need 1–3 sessions for best results',
        'Free initial consultation (phone or in-person)',
        'Flexible scheduling for Incline Village residents',
      ],
      cta: 'All services are performed at our Sparks studio, with transparent pricing discussed during consultation.',
    },

    idealFor: {
      heading: 'Why Choose Revivelle Ink from Incline Village?',
      intro: 'Residents of Incline Village choose Revivelle Ink because:',
      criteria: [
        'It\'s the closest specialized paramedical tattoo studio for scars and stretch marks',
        'Advanced services not commonly available in resort communities',
        'Emphasis on privacy, discretion, and natural results',
        'Licensed, insured, and professionally trained care',
        'Custom treatments designed for all skin tones',
        'Appointment-only scheduling that respects travel and privacy',
      ],
      note: 'Many Incline Village clients appreciate having access to high-level restorative care without compromising on comfort or quality.',
    },

    commonAreas: [
      'Incline Village Crystal Bay',
      'Eastern Slope',
      'Lakeshore Boulevard area',
      'Championship Drive',
      'Upper Tyner Way neighborhoods',
    ],

    faqs: [
      {
        question: 'Do you serve Incline Village residents?',
        answer: 'Yes. Many clients visit us from Incline Village for paramedical tattoo services.',
      },
      {
        question: 'How do I get to your studio from Incline Village?',
        answer: 'Most clients take Mount Rose Highway (NV-431) toward Sparks.',
      },
      {
        question: 'How long does it take to drive from Incline Village to your studio?',
        answer: 'Typically 35–40 minutes, depending on weather and traffic.',
      },
      {
        question: 'Do Incline Village residents receive the same services and pricing?',
        answer: 'Yes. All clients receive the same professional care and pricing.',
      },
      {
        question: 'Is parking available near your studio?',
